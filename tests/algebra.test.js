...
test("cross3", () => {
	...
	expect(Number.isNaN(math.core.cross3([-3, 0], [5, -1, 2])[0])).toBe(true);
	expect(Number.isNaN(math.core.cross3([-3, 0], [5, -1, 2])[1])).toBe(true);
	expect(Number.isNaN(math.core.cross3([-3, 0], [5, -1, 2])[2])).toBe(false);
});
