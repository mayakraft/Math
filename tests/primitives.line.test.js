...
// 	expect(math.equivalent(...args)).toBe(true);
// };
...
// test("u d form", () => {
// 	const l1 = math.line.fromNormalDistance({ normal: [1, 0], distance: 3 });
...
// });
// test("flip", () => {
// 	const result = math.ray([1, 2], [3, 3]).flip();
// 	expect(result.origin.x).toBe(3);
// 	expect(result.origin.y).toBe(3);
// 	expect(result.vector.x).toBe(-1);
// 	expect(result.vector.y).toBe(-2);
...
// });
// test("transform", () => {
// 	const result1 = math.segment([1, 2], [3, 4]).transform(math.matrix().scale([0.5, 0.5, 0.5]));
