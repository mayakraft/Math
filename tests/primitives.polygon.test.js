...
// 	expect(math.makePolygonCircumradius(4).sides.length).toBe(4);
// 	expect(math.makePolygonCircumradius(4).area()).toBeCloseTo(2);
// });

// // todo: convex
// test("isConvex", () => {
// 	expect(math.makePolygonCircumradius(4).isConvex).toBe(undefined);
// });
// test(".segments", () => {
// 	const polygon = math.makePolygonCircumradius(4);
...
// test("intersect", () => {
// 	const polygon = math.makePolygonCircumradius(4);
// 	const segment = math.intersectLineLine(polygon, [1, 1], [0, 0]);
