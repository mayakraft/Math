...
// 	expect(math.fnEpsilonEqualVectors(seg0[0], result0[0])).toBe(true);
// 	expect(math.fnEpsilonEqualVectors(seg0[1], result0[1])).toBe(true);
// 	// all outside
...
// 		math.includeS,
// 	);
// 	expect(math.fnEpsilonEqualVectors(seg2[0], result2[0])).toBe(true);
// 	expect(math.fnEpsilonEqualVectors(seg2[1], result2[1])).toBe(true);
...
// 	expect(math.fnEpsilonEqualVectors(seg4[0], result4[0])).toBe(true);
// 	expect(math.fnEpsilonEqualVectors(seg4[1], result4[1])).toBe(true);
// });
