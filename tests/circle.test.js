...
test("intersect lines", () => {
  ...
  math.core.equivalentVectors(clipLine[0], shouldBeLine[0]);
  math.core.equivalentVectors(clipLine[1], shouldBeLine[1]);
  // no intersect
