...
test("basisVectors2", () => {
	expect(math.basisVectors2().length).toBe(2);
	const basis1 = math.basisVectors2([1, 0]);
	// [-v[1], v[0]]
	...
	const basis2 = math.basisVectors2([500, 0]);
	...
	const basis3 = math.basisVectors2([0, 500]);
	...
	const basis4 = math.basisVectors2([20, 20]);
	...
	const basis5 = math.basisVectors2([0, 0]);
...
test("basisVectors3", () => {
	expect(math.basisVectors3().length).toBe(3);
	const basis1 = math.basisVectors3([1, 0, 0]);
	expect(basis1[0][0]).toBeCloseTo(1);
	expect(basis1[0][1]).toBeCloseTo(0);
	...
	const basis2 = math.basisVectors3([0, 0, 500]);
	...
	const basis3 = math.basisVectors3([1, 1, 1]);
	...
	const basis4 = math.basisVectors3([0, 0, 0]);
